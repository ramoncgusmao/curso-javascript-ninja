...
(function(){
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/, 'Ramon Cantanhede Gusmao'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'ludovicense'));
    /*
    ...
    */
    ...
    function getMonthNumber(mes){
        ...
        return meses[mes] ? meses[mes] : 'não existe esse mes';
    }
