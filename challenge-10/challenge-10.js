...
(function(){
    ...
    */
    console.log( !!sum ? `${showOperationMessage(operationSignal,number1, number2)} ${sum(number1,number2)} ` : showErrorMessage(operationSignal) );
   ...
   var subtract = calculator(operationSignalSubtract);
   console.log( !!subtract ? `${showOperationMessage(operationSignalSubtract,number1, number2)} ${subtract(number1,number2)} ` : showErrorMessage(operationSignalSubtract) );

   operationSignalMultiplication = '*';
   var multiplication = calculator(operationSignalMultiplication);
   console.log( !!multiplication ? `${showOperationMessage(operationSignalMultiplication,number1, number2)} ${multiplication(number1,number2)} ` : showErrorMessage(operationSignalMultiplication) );

   operationSignalDivision = '/';
   var division = calculator(operationSignalDivision);
   console.log( !!division ? `${showOperationMessage(operationSignalDivision,number1, number2)} ${division(number1,number2)} ` : showErrorMessage(operationSignalDivision) );

   operationSignalMod = '%';
   var mod = calculator(operationSignalMod);
   console.log( !!mod ? `${showOperationMessage(operationSignalMod,number1, number2)} ${mod(number1,number2)} ` : showErrorMessage(operationSignalMod) );
   ...
   operationSignalInvalid = '@';
   var invalid = calculator(operationSignalInvalid);
